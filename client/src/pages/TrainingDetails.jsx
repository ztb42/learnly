...
const TrainingDetails = () => {
    ...
    return (
        <Container maxWidth="md" sx={{ mt: 6 }}>
            ...
            {/* Sessions */}
            <Typography variant="h6" mb={1}>Sessions</Typography>
            ...
            {(() => {
                ...
                usedSessions.forEach((session) => {
                    ...
                    if (!sessionsMap.has(day)) {
                        sessionsMap.set(day, time);
                    }
                });

                const sortedSessions = weekOrder
                    .filter((day) => sessionsMap.has(day))
                    .map((day) => ({ day, time: sessionsMap.get(day) }));
            ...
            {/* Lessons */}
            <Typography variant="h6" mb={1}>Lessons</Typography>
                        ...
                        <Grid item xs={12} sm={6} key={index}>
                            <Card sx={{ backgroundColor: "#111", color: "#fff" }}>
                                <CardContent>
                                    ...
                                    {session ? (
                                        <>
                                            <Typography variant="body2">Time: {session.sessionTime}</Typography>
